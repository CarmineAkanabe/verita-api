<x-mail::layout>
    ...
    <x-slot:footer>
        <x-mail::footer>
            <div
                style="text-align: center; color: #6B7280; font-size: 11px; line-height: 1.6; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                ...
                <p style="margin: 0; color: #9CA3AF; font-size: 10px; line-height: 1.4;">
                    <strong>CONFIDENTIALITY NOTICE:</strong> This notification contains privileged Case Reporter
                    communications managed under ISO 37002 anti-retaliation and zero-knowledge privacy protocols. No IP
                    addresses or device identifiers are retained.
                </p>
