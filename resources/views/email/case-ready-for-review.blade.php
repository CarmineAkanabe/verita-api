<x-mail::message>
    ...
    A new Case Reporter disclosure in **{{ $case->department?->name ?? 'your department' }}** has completed automated AI
    intake processing and is now awaiting assessment in your departmental triage queue.
    ...
    ### Next Steps
    Review the synthesized incident chronology and evidence vault. You may claim this docket in the staff portal to
