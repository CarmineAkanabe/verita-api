<x-mail::message>
    ...
    A confidential incident disclosure has been assigned to your investigation docket by Executive Management. Under
    Verita corporate governance and ISO 37002 compliance protocols, you have been designated as the primary investigator
    for this case.
    ...
    <x-mail::panel>
        ...
        - **Date of Incident:**
        {{ $case->transaction_date ? \Carbon\Carbon::parse($case->transaction_date)->format('d M Y') : 'Not specified' }}
    ...
    ### Required Action
    Please log in to the secure staff portal to examine attached evidentiary files, review automated AI timeline
    findings, and initiate confidential two-way communication with the Case Reporter.
    ...
    <x-slot:subcopy>
        If you are having trouble clicking the "Open Case in Portal" button, copy and paste the following URL into your
        web browser:
