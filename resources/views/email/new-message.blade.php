<x-mail::message>
# New Whistleblower Consultation Message

Hello Officer,

A new confidential message has been received from the anonymous whistleblower on Case **#{{ strtoupper(substr($message->case_record_id, 0, 8)) }}**.
...
Because this matter is under active investigation, please access the consultation channel to read the disclosure and provide a timely response.
